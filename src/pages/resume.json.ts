...
const resumeData = {
  ...
  highlights: [
    ...
    },
    {
      ...
      context: "plus a multi-vendor SaaS stack and provider agreements"
    },
    {
      value: "+177%",
      label: "Digital category traffic",
      context: "Walmart 'Project Windex' award"
    }
  ],
  experience: [
    {
  ...
  caseStudies: [
    ...
    },
    {
      ...
      outcomes: ["+20% YoY category sales", "Improved search/browse journeys"]
    },
    {
      name: "Project Windex",
      ...
      outcomes: ["+177% digital category traffic", "Improved revenue & profit"]
    }
  ],
  competencies: [
    "Ecommerce strategy",
